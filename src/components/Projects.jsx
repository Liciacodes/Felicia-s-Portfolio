  ...
  return (
    ...
    >
      <div className="w-full max-w-4xl mx-auto">
        <h2 className="border-l-4 p-0 md:p-2 pl-2 border-[#F7861D] text-2xl font-normal mb-6 text-black leading-[22.79px]">
        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="flex flex-col w-full md:w-[466px] h-auto md:h-[291px] mt-4 md:mt-0">
