    ...
    <section className="mt-20 md:mt-[148px] flex flex-col items-center px-4 sm:px-6 lg:px-0 w-full">
      <div className="w-full max-w-4xl mx-auto">
        ...
        {projects.map((project, index) => (
          <div
            key={index}
            className="flex flex-col md:flex-row items-stretch gap-4 mb-20 md:gap-y-0 md:gap-x-5 w-full"
          >
            ...
            <div className="flex flex-col w-full md:w-[50%] md:mt-0">
              <div className="relative h-full w-full">
                ...
                <div className="hidden md:block absolute left-0 right-0 mt-[16px]">
                  ...
                  <div className="text-[#592C03] font-medium flex flex-wrap gap-x-3 gap-y-2 ">
